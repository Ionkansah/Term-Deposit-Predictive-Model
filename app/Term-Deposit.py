...
if options == "Home":
    st.title("Welcome to the Term Deposit Predictor")
    st.write("This app provides insights into predicting term deposit subscriptions.")
elif options == "EDA":
    ...
    # Include your model results and classification report table here
    ...
    st.markdown(
        ...
        <div class="icon-row">
            <a href="https://www.facebook.com/IsaacOpokuNkansah/" target="_blank">
                <img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" alt="Facebook">
            </a>
            <a href="https://instagram.com/ionkansah/" target="_blank">
                <img src="https://cdn-icons-png.flaticon.com/512/733/733558.png" alt="Instagram">
            </a>
            <a href="https://github.com/Ionkansah" target="_blank">
                <img src="https://cdn-icons-png.flaticon.com/512/733/733553.png" alt="GitHub">
            </a>
            <a href="mailto:akwasi3g@gmail.com">
                <img src="https://cdn-icons-png.flaticon.com/512/732/732200.png" alt="Email">
            </a>
            <a href="https://www.kaggle.com/isaacopokunkansah" target="_blank">
                <img src="https://cdn.iconscout.com/icon/free/png-256/kaggle-3628695-3030176.png" alt="Kaggle">
            </a>
            <a href="https://www.youtube.com/@ionfactstv" target="_blank">
